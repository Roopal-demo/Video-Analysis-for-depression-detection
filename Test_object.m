...
% result_class{2}='Anger';
% result_class{3}='Anger';
% result_class{4}='Happy';
% result_class{5}='Happy';
% result_class{6}='Happy';
% result_class{7}='Disgust';
% result_class{8}='Disgust';
% result_class{9}='Disgust';
% result_class{10}='Sad';
% result_class{11}='Sad';
% result_class{12}='Sad';
% result_class{13}='Surprise';
% result_class{14}='Surprise';
result_class{1}='Anger';
...
figure;
traincl=[1 2 3 4 5 6 7 8];
traincls=full(ind2vec(traincl));
plotconfusion(finalt,traincls);
